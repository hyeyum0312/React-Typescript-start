...
const Sidebar: React.FC<SidebarProps> = ({ sidebarContent }) => {
  ...
  // hint: useRecoilValue
  console.log('UserAtom',UserAtom) // key:"user-atom"
  const [userProfile, setUserProfile] = useRecoilState(UserAtom)
  console.log('userProfile',userProfile);
  // userProfile 모양
  // {userId:0
  // userInfo:{name: 'blueStragglr', roles: roles:(2) ['user', 'admin']}
  // username:"blue"}
